...
Explore these concepts more with an [interactive notebook](/jump-in/python/notebooks/datatypes-and-operators-nb.ipynb){target="_blank"} or keep learning with [variables and functions](/jump-in/python/variables-and-functions.qmd) next.
