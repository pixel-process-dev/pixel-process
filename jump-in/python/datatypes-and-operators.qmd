...
See [Iteration and Flow Control](/jump-in/python/iteration-and-flow-control.qmd) for more on working with sequences and Boolean types often used for flow control.
