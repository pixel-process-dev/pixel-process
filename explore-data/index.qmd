...
| --- | --- | --- | --- |
| Dataset Exploration |  | {{< fa regular rectangle-list >}} [Show](/explore-data/datasets/dataset-exploration-nb.ipynb) | {{< fa regular file-code >}} [Binder](/create-code/binder-quickstart.qmd) |
| Data Viz Basics | {{< fa regular window-maximize >}} [Open](/explore-data/data-viz/data-viz-basics.qmd) | {{< fa regular rectangle-list >}} [Show](/explore-data/data-viz/data-viz-basics-nb.ipynb) | {{< fa regular file-code >}} [Binder](/create-code/binder-quickstart.qmd) |
| Data Viz Building Blocks | {{< fa regular window-maximize >}} [Open]({{{data-viz-building-blcoks}}}) | {{< fa regular rectangle-list >}} [Show](/explore-data/data-viz/data-viz-building-blocks-nb.ipynb) | {{< fa regular file-code >}} [Binder](/create-code/binder-quickstart.qmd) |
| Image Basics |  | {{< fa regular rectangle-list >}} [Show](/explore-data/advanced-data/image-basics.ipynb) | {{< fa regular file-code >}} [Binder](/create-code/binder-quickstart.qmd) |
