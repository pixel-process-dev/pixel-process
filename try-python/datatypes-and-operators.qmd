...
Dig in deeper with this [interactive notebook](/try-python/notebooks/datatypes-and-operators-nb.ipynb){target="_blank"} or move on to [variables and functions](/try-python/variables-and-functions.qmd) next.
