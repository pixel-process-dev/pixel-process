...
Debugging is most effective when structured, check out [On the Shoulders of Giants](/create-code/shoulders-of-giants.qmd) for more general troubleshooting tips.
:::
...
Debugging works a lot like scientific research. Instead of guessing randomly, treat each step as a test:
...
Ready to test out your new skills? Take on this [Expert Debugger Challenge](/try-python/notebooks/hello-world-challenge-nb.ipynb).
